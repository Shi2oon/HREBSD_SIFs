...
%         Maps.rot.PHs{i,j}   = griddata(Xnew,Ynew,Maps.PHs{i,j}(:),xq,yq);
%         Maps.rot.MAEs{i,j}  = griddata(Xnew,Ynew,Maps.MAEs{i,j}(:),xq,yq);
%         Maps.rot.RefIDs{i,j} = griddata(Xnew,Ynew,Maps.RefIDs{i,j}(:),xq,yq);
    end
end
