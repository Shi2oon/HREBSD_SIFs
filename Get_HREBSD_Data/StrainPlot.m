...
h1 = subplot(3,3,1);            pcolor(Xvec,Yvec,E11);shading interp;
...
h2 = subplot(3,3,2);            pcolor(Xvec,Yvec,E12);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
colorbar;                       caxis([Miniall Maxiall]); 
title('\fontsize{16}\epsilon\fontsize{10}12')

h3 = subplot(3,3,3);            pcolor(Xvec,Yvec,E13);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
colorbar;                       caxis([Miniall Maxiall]); 
title('\fontsize{16}\epsilon\fontsize{10}13')

h4 = subplot(3,3,5);            pcolor(Xvec,Yvec,E22);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
colorbar;                       caxis([Miniall Maxiall]); 
title('\fontsize{16}\epsilon\fontsize{10}22')

h5 = subplot(3,3,6);            pcolor(Xvec,Yvec,E23);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
colorbar;                       caxis([Miniall Maxiall]); 
title('\fontsize{16}\epsilon\fontsize{10}23')

h6 = subplot(3,3,9);            pcolor(Xvec,Yvec,E33);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]); 	ylim([min(Yvec) max(Yvec)])
...
h7 = subplot(3,3,4);            pcolor(Xvec,Yvec,Wo);shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
colorbar;                       title('W')

h8 = subplot(3,3,7);            pcolor(Xvec,Yvec,GNDs); ;shading interp;
set(gca,'Ydir','normal');       axis equal;     axis tight
xlim([min(Xvec) max(Xvec)]);    ylim([min(Yvec) max(Yvec)])
